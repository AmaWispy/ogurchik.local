...
@section('title', 'Случайные статьи - ' . config('app.name'))
@section('meta_description', 'Случайная подборка статей на сайте ' . config('app.name'))

@section('content')
    <section class="main-title">
        <h1>Случайные статьи</h1>
        <p>Откройте для себя что-то новое</p>
    </section>
